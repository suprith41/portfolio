              ...
              <div className="space-y-4 p-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 rounded-xl border border-black/10 bg-white px-3 py-2 text-[11px] uppercase tracking-[0.18em] text-neutral-600 transition hover:border-black/20 hover:text-black"
                  >
                    Reset
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      try {
                        ...
                        alert("Pillar settings copied to clipboard")
                      } catch (err) {
                        // eslint-disable-next-line no-alert
                        alert("Copy failed")
                      }
                    }}
                    className="rounded-xl border border-black/10 bg-white px-3 py-2 text-[11px] uppercase tracking-[0.18em] text-neutral-600 transition hover:border-black/20 hover:text-black"
                  >
                    Copy
                  </button>
