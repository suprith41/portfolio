          ...
          <div className="px-6 md:px-12 py-8 md:py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
              ...
              <div className="order-1 md:order-none">
                ...
                {/* Social Media Links - Simple Monochrome */}
                <div className="space-y-4 text-center md:text-left">
                  ...
                  <div className="flex gap-4 justify-center md:justify-start">
                    {/* Instagram */}
                    <Link 
                      href="https://www.instagram.com/sat_dez" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-gray-400 hover:text-pink-500 transition-colors duration-200"
                    >
                      <Image 
                        src="/images/HomeImages/social/instagram.svg" 
                        alt="Instagram"
                        width={40}
                        height={40}
                    ...
                    >
                      <Image 
                        src="/images/HomeImages/social/linkedin.svg" 
                        alt="LinkedIn"
                        width={40}
                        height={40}
                        className="w-10 h-10 md:w-12 md:h-12"
                    ...
                    {/* Behance */}
                    <Link 
                      href="https://www.behance.net/satish-designs" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-gray-400 hover:text-blue-500 transition-colors duration-200"
                    >
                      <Image 
                        src="/images/HomeImages/social/behance.svg" 
                        alt="Behance"
                        width={40}
                        height={40}
                        className="w-10 h-10 md:w-12 md:h-12"
                    ...
                    {/* Dribbble */}
                    <Link 
                      href="https://dribbble.com/Satish-Hebbal" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-gray-400 hover:text-pink-500 transition-colors duration-200"
                    >
                      <Image 
                        src="/images/HomeImages/social/dribbble.svg" 
                        alt="Dribbble"
                        width={40}
                        height={40}
                        className="w-10 h-10 md:w-12 md:h-12"
              ...
              {/* Right Column - Logo (Mobile: order first, Desktop: normal order) */}
